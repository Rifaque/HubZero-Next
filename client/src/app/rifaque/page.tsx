...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${data.fullname} | Portfolio`,
    description: `Explore the portfolio of ${data.fullname}, a skilled ${data.title} building robust full-stack apps using MERN and Next.js. Dive into software projects, cloud deployments, and contact details.`,
